...
[![NuGet](http://img.shields.io/nuget/v/Atata.ExtentReports.svg?style=flat)](https://www.nuget.org/packages/Atata.ExtentReports/)
[![GitHub release](https://img.shields.io/github/release/atata-framework/atata-extentreports.svg)](https://github.com/atata-framework/atata-extentreports/releases)
[![Build status](https://dev.azure.com/atata-framework/atata/_apis/build/status/atata-extentreports-ci?branchName=main)](https://dev.azure.com/atata-framework/atata/_build/latest?definitionId=61&branchName=main)
...
- [ExtentReports](https://www.nuget.org/packages/ExtentReports) package
